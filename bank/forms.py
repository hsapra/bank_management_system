...
class LoginForm(forms.Form):
    ...
    pwd = forms.CharField(label='Password', max_length=100, widget=forms.PasswordInput())
...
class AddAccountForm(forms.Form):
    ...
    accountType = forms.CharField(label = "Account Type", widget=forms.Select(choices=[("Savings", "Savings"), ("Checking", "Checking"), ("Market", "Market")]))
    ...
    class Meta:
        model = BankAccount
        fields = ('bankid', 'customerID', 'accountID', 'accountType','initialBalance', 'interestRate', 'minbalance', 'maxwithdrawals')
...
class AddAccountAccessForm(forms.Form):
    ...
    class Meta:
        model = BankAccount
        fields = ('bankid', 'sharerID', 'accountID',)
